...
//				dom3.removeClass("feLv feLs feCs feFs hcBsFe hcHsFe hcNsFe hcZsFe")
				dom1.addClass('fmHsdy');
				dom2.addClass('fdHsdy');
				dom3.addClass('feHsdy');
			break;
			case "黄色太和":
				dom1.addClass('fmHsth');
				dom2.addClass('fdHsth');
				dom3.addClass('feHsth');
			break;
			case "红色祥云":
				dom1.addClass('fmHsxy');
				dom2.addClass('fdHsxy');
				dom3.addClass('feHsxy');
			break;
			case "黄色窗棂":

				dom1.addClass('fmHscl');
				dom2.addClass('fdHscl');
				dom3.addClass('feHscl');
				break;
			//画册白色	
			case "纯真白":
