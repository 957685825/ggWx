	...
	export default{
		data(){
			return{
				...
				skuId:'',
				showImgData:[
				{id:'黄色太和',imgUrl:'http://image2.artup.com/static/pc/gugong/hsthzs.jpg'},
				{id:'殿宇红',imgUrl:'http://image2.artup.com/static/pc/gugong/hsdyzs.jpg'},
				{id:'黄色窗棂',imgUrl:'http://image2.artup.com/static/pc/gugong/hsclzs.jpg'},
				{id:'红色祥云',imgUrl:'http://image2.artup.com/static/pc/gugong/hsxyzs.jpg'}
				],
				showImgUrl:'http://image2.artup.com/static/pc/gugong/hsthzs.jpg'
			}
		},
		methods:{
			check(params){ //切换选项		
				...
				for(var t=0; t<this.showImgData.length;t++){
					if($("#bbs-select .slect_dl > dd .dd_slectWidth").eq(params.index2).text() === this.showImgData[t].id){
						this.showImgUrl = this.showImgData[t].imgUrl
					}
				}
